...
function displayBagItems() {
  ...
  bagItemObject.forEach((bagItems) => {
    innerHTML += genearteItemHTML(bagItems);
  });
...
function genearteItemHTML(item) {
  ...
  <div class="item-right-part">
    ...
    <div class="delivery-details">Delivery by<span class="delivery-details-days"> ${item.delivery_date}</span>
    </div>
  </div>
